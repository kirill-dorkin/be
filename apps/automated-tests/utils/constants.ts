...
export const storeHeaders = {
  heroBanner: "Welcome to BestElectronics",
  productsCarousel: "BestElectronics products",
  productsCarouselDescription:
    "See what BestElectronics has to offer in the storefront demo version.",
  newsletter: "Subscribe to Newsletter",
  productListingPage: "All BestElectronics best products",
};

  ...
  return (
    <div className="flex min-h-[60vh] w-full items-center justify-center px-4 py-12 md:py-16">
      <div className="flex w-full max-w-md flex-col items-center">
        {/* Icon container */}
        <div className="mb-6 flex h-24 w-24 items-center justify-center rounded-full border border-border/60 bg-muted/30 sm:mb-8 sm:h-28 sm:w-28">
          <ShoppingBag
        ...
        {/* CTA Button */}
        <LocalizedLink href={paths.search.asPath()} className="w-full sm:w-auto">
          <Button
            size="lg"

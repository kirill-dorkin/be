  ...
  return (
    <Card className="border-dashed">
      <CardContent className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <h3 className="mb-2 text-2xl font-bold text-slate-900 dark:text-primary">
          {t("referral.empty-title")}
        </h3>

        <p className="mb-8 max-w-md text-base text-slate-600 dark:text-muted-foreground">
        ...
        <div className="grid w-full max-w-2xl gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-900/50">
            ...
            <h4 className="mb-1 text-sm font-semibold text-slate-900 dark:text-primary">

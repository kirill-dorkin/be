...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    <section className="w-full bg-gradient-to-b from-slate-50/50 via-white to-white dark:from-slate-900 dark:via-slate-950/70">
      <div className="container px-4 pb-8 pt-4 sm:px-4 sm:pt-8 md:pb-16 space-y-4">
        <AccountQuickLinks />
        <div className="text-slate-700 dark:text-primary mx-auto flex w-full max-w-6xl flex-col gap-6 rounded-3xl border border-slate-100/80 bg-white/95 px-4 py-5 shadow-lg ring-1 ring-black/5 dark:border-slate-900/60 dark:bg-slate-900/70 dark:ring-white/5 sm:rounded-[28px] sm:px-6 sm:py-6 md:px-10 md:py-10">

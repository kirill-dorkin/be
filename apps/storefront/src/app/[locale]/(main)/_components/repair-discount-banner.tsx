...
export const RepairDiscountBanner = async ({
  ...
  return (
    <section className="relative mb-14 overflow-hidden rounded-3xl border border-neutral-200 bg-white text-neutral-900 shadow-[0_24px_80px_rgba(15,23,42,0.12)] dark:border-white/10 dark:bg-neutral-950 dark:text-white dark:shadow-[0_48px_120px_rgba(0,0,0,0.45)]">
      ...
      <div className="relative grid gap-10 p-10 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] lg:p-16">
        <div className="space-y-6">
          ...
          <p className="text-base text-neutral-600 sm:text-lg dark:text-white/75">
            {description}
          </p>

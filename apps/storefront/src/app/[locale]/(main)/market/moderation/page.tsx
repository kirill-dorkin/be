        ...
        {items.map((item) => (
          <Card key={item.id} className="h-full">
            ...
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              ...
              <p className="text-xs text-foreground">Контакт: {item.contact}</p>
              {item.status === "pending" && (
    ...
    <div className="container max-w-6xl pb-16 pt-10">
      <div className="flex flex-col gap-2 pb-6">
        ...
        <p className="text-muted-foreground text-base">
          Только сотрудники могут одобрять или отклонять товары перед публикацией.
        </p>
      </div>
      ...
      <div className="space-y-6">
        <div className="rounded-2xl border border-border/60 bg-card/70 p-5 shadow-sm">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-foreground">В ожидании</h2>
        ...
        <div className="rounded-2xl border border-border/60 bg-card/70 p-5 shadow-sm">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-foreground">Опубликовано</h2>
        ...
        <div className="rounded-2xl border border-border/60 bg-card/70 p-5 shadow-sm">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-foreground">Отклонено</h2>

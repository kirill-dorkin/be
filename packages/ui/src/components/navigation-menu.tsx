...
const NavigationMenuViewport = ({
  ...
  <div className={cn("center absolute top-full flex w-full justify-center")}>
    <NavigationMenuPrimitive.Viewport
      ...
      className={cn(
        "origin-top-center bg-background text-foreground data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full max-w-screen-lg overflow-hidden rounded-md shadow-2xl",
        className,
      )}
      {...props}
    />

...
const TAXONOMY_MAP = {
  ...
  "Комплектующие > Игровая мебель ПРИ САМОСТОЯТЕЛЬНОЙ СБОРКЕ МЕБЕЛИ КЛИЕНТОМ ФИРМА ОТВЕТСТВЕННОСТЬ НЕ НЕСЕТ":
    ["Периферия и игры", "Игровая мебель", "Комплекты"],
  ...
  "Комплектующие > Корпуса и блоки питания > Корпуса без блоков питания > ASUS":
    ["Компьютерные комплектующие", "Корпуса и питание", "Корпуса ASUS"],
  "Комплектующие > Корпуса и блоки питания > Корпуса без блоков питания > DEEPCOOL":
    ["Компьютерные комплектующие", "Корпуса и питание", "Корпуса DeepCool"],
  "Комплектующие > Корпуса и блоки питания > Корпуса без блоков питания > DELUX":
    ["Компьютерные комплектующие", "Корпуса и питание", "Корпуса Delux"],
  "Комплектующие > Корпуса и блоки питания > Корпуса без блоков питания > GIGABYTE":
    ["Компьютерные комплектующие", "Корпуса и питание", "Корпуса Gigabyte"],
  "Комплектующие > Корпуса и блоки питания > Корпуса без блоков питания > WINSTAR":
    ["Компьютерные комплектующие", "Корпуса и питание", "Корпуса Winstar"],
  ...
  "Комплектующие > Мыши > Мыши A4TECH": ["Периферия и игры", "Мыши", "A4Tech"],
  "Комплектующие > Мыши > Мыши ASUS": ["Периферия и игры", "Мыши", "ASUS"],
  "Комплектующие > Мыши > Мыши BenQ ZOWIE": [
    "Периферия и игры",
    "Мыши",
    "BenQ Zowie",
  ],
  "Комплектующие > Мыши > Мыши DELUX": ["Периферия и игры", "Мыши", "Delux"],
  "Комплектующие > Мыши > Мыши GENIUS": ["Периферия и игры", "Мыши", "Genius"],
  "Комплектующие > Мыши > Мыши HyperX": ["Периферия и игры", "Мыши", "HyperX"],
  ...
  "Комплектующие > Системы безопасности > Видеокамеры > HDCVI,HDTVI купольные":
    ["Системы безопасности", "Видеонаблюдение", "HDCVI/HDTVI купольные"],
  "Комплектующие > Системы безопасности > Видеокамеры > HDCVI,HDTVI цилиндрические":
    ["Системы безопасности", "Видеонаблюдение", "HDCVI/HDTVI цилиндрические"],
  ...
  "Комплектующие > Сканеры": ["Печать и офис", "Сканирование", "Сканеры"],
  ...
  "Комплектующие > Товары с уценкой > Notebook с уценкой > Запчасти для Ноутбуков":
    ["Уценка и распродажа", "Ноутбуки уцененные", "Запчасти"],
  "Комплектующие > Товары с уценкой > Notebook с уценкой > Экраны для ноутбуков":
    ["Уценка и распродажа", "Ноутбуки уцененные", "Матрицы"],
  ...
  "Комплектующие > Товары с уценкой > Корпуса без блоков питания с уценкой > DEEPCOOL УЦЕНКА":
    ["Уценка и распродажа", "Комплектующие", "Корпуса DeepCool"],
  "Комплектующие > Товары с уценкой > Кулеры с уценкой > Кулер видекарты УЦЕНКА":
    ["Уценка и распродажа", "Комплектующие", "Охлаждение видеокарт"],
  ...
  'Комплектующие > Товары с уценкой > Мониторы с уценкой > Мониторы "LCD 18.5" УЦЕНКА':
    ["Уценка и распродажа", "Мониторы и дисплеи", "18-19 дюймов"],
  'Комплектующие > Товары с уценкой > Мониторы с уценкой > Мониторы "LCD 19.5 +" УЦЕНКА':
    ["Уценка и распродажа", "Мониторы и дисплеи", "19 дюймов и больше"],
  ...
  "Комплектующие > Факсы & Телефоны > Кабели и зарядки для мобильных устройств":
    ["Аксессуары и гаджеты", "Мобильные аксессуары", "Кабели и зарядки"],

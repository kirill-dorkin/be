      ...
      >
        <div className="relative flex flex-col gap-6 px-5 pb-6 pt-6">
          <DialogTitle className="sr-only">
            Приглашение в клуб BestElectronics
          </DialogTitle>
          <DialogClose className="absolute right-5 top-5 rounded-full bg-white p-3 text-slate-500 shadow-[0_0_0_2px_rgba(15,23,42,0.08)] focus:outline-none focus:ring-0 focus:ring-offset-0">
            <X className="h-4 w-4" />

...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <main className="relative flex flex-col items-center text-center px-6 z-10 gap-8 max-w-4xl mx-auto">
        ...
        <nav className="flex flex-col sm:flex-row justify-center gap-6 mt-8" aria-label="Основная навигация">
          {!isLoggedIn && (

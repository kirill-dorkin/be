      ...
      this.webVitalsObserver = new PerformanceObserver((list) => {
        ...
        entries.forEach((entry) => {
          ...
          if (entry.entryType === 'first-input') {
            this.updateWebVital('fid', (entry as PerformanceEventTiming).processingStart - entry.startTime);
          }
      ...
      <div className={`bg-white p-4 rounded-lg shadow-sm border ${className}`}>
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-4 text-xs">
            ...
            <span className={`font-medium ${getScoreColor('fid', metrics.webVitals.fid)}`}>
              FID: {formatValue('fid', metrics.webVitals.fid)}
            </span>

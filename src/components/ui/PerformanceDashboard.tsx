        ...
        {pageLoadMetrics && (
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div className="flex justify-between">
                <span>Total:</span>
                <span className="font-mono font-bold">{Math.round(pageLoadMetrics.total)}ms</span>
              </div>
            </div>
          </div>
        )}
        ...
        {memoryMetrics && (
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs text-center text-gray-600">{memoryMetrics.usage.toFixed(1)}% used</div>
            </div>
          </div>
        )}

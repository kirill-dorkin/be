...
import { Settings, DollarSign, Activity, TrendingUp } from 'lucide-react';
import { useServiceStats } from './hooks';
import { formatPrice } from './utils';

const ServiceStats: React.FC = () => {
  const { stats, loading } = useServiceStats();
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Активных услуг</CardTitle>
